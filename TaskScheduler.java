...
public class TaskScheduler {
    public static void main(String[] args) {
        try {
            Map<String, Employee> employees = loadEmployeesFromFile("C:\\Users\\cscsm\\IdeaProjects\\workersss\\src\\main\\java\\org\\example\\employees.xlsx");

            TaskManager taskManager = new TaskManager(employees);
            taskManager.assignTasks();

            saveTasksToFile(taskManager.getTasks(), "C:\\Users\\cscsm\\IdeaProjects\\workersss\\src\\main\\java\\org\\example\\tasks_completed.xlsx");
